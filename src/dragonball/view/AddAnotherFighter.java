...
public class AddAnotherFighter extends GameVeiw implements Serializable {
	...
	private Font JcustomFont; 
	 ...
	 public AddAnotherFighter( JFrame Parent, String playername, Game game) {
    ...
    FighterName.addKeyListener(new KeyListener() {
	    ...
	    Next2.addActionListener(new AddAnotherFighterHandler( this, parent, FighterName,super.getGame(),FighterrType));
		add(CreateFighter);
