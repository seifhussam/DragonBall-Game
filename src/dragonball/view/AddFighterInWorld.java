...
import dragonball.controller.AddAnotherFighterHandler;
import dragonball.controller.AddFighterHandlerInWorld;
...
import dragonball.view.CreateFighterVeiw.ImageListener;

public class AddFighterInWorld extends GameVeiw implements Serializable {
	...
	private Font JcustomFont; 
	 ...
	 public AddFighterInWorld( JFrame Parent, String playername, Game game) {
       ...
       Font cFont = new Font("Serif",Font.BOLD,42) ;  
		...
		Create = new JLabel("Hello " + PlayerName);
    ...
    FighterName.addKeyListener(new KeyListener() {
	    ...
	    Next2.addActionListener(new AddFighterHandlerInWorld( this, parent, FighterName,super.getGame(),FighterrType));
		add(CreateFighter);
